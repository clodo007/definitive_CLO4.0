// import { ChatInputCommandInteraction, GuildMember, Role, SlashCommandBuilder, EmbedBuilder } from "discord.js";
// import { Role as RoleDB } from "../../schemas/serverRoles";
// import { User } from "../../schemas/serverUsers";
// import { Category } from "../../schemas/serverCategories";
// import { canUseCommand } from "../moderation/verificacaoDeCargos";
...
//     );
//     return interaction.reply(
//       `❌ ${jogador.user} perdeu a tag [<@&${cargoMesa.id}>] da mesa do mestre <@${mestre.id}>`
//     );
//   }
// }
