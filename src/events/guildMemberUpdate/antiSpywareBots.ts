...
// const PROHIBITED_ROLE_ID = '1447571877051764912'; 
// const GENERAL_CHANNEL_ID = "1440432088267489470"; 
// const EMBED_COLOR: ColorResolvable = 'Red';
// const GIF_PATH = path.join(__dirname, '../../assets/gifsForEmbedds/lock-missile.gif'); 
...
//     if (roleAdded && roleAdded.id === PROHIBITED_ROLE_ID) {
...
//         if (generalChannel) {
//             try {
//                 const attachment = new AttachmentBuilder(GIF_PATH, { name: 'lock.gif' });

//                 const embed = new EmbedBuilder()
//                     .setTitle('🚨 Conta Suspeita Detectada')
//                     .setDescription(`O usuário **${newMember.user.username}** foi banido do servidor, Após voluntariamente selecionar no Onboarding a opçao **"Sou um bot"**, Implicando que a conta possivelmente é um Bot suspeito, ou possui um dono Iletrado`)
